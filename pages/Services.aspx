<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Services.aspx.cs" Inherits="pages_Services" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" Runat="Server">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <img class="img-responsive" src="~/template_images/Services/Services.jpg" alt="" runat="server"/>
            </div>
        </div>
        <!-- /.row -->
